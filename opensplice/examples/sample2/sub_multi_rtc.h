    ...
    : public RTC::DataFlowComponentBase
{
    ...
    private:
		...
		std::vector<RTC::DDSSubPort<TestDataType, DDS_sequence_TestDataType,
            TestDataTypeDataReader, TestDataTypeFunc>*> port_ary_;
        RTC::DDSSubPort<TestDataType, DDS_sequence_TestDataType,
            TestDataTypeDataReader, TestDataTypeFunc> port1_;
        RTC::DDSSubPort<TestDataType, DDS_sequence_TestDataType,
            TestDataTypeDataReader, TestDataTypeFunc> port2_;
        RTC::DDSSubPort<TestDataType, DDS_sequence_TestDataType,
            TestDataTypeDataReader, TestDataTypeFunc> port3_;
};
